//biblioteca que está sendo utilizada no html
...
//arrow function (função no java script)
...
const concluiratividade = (event) => {
  ...
  const datadesteimput = imput.value
